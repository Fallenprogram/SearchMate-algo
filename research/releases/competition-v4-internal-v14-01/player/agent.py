"""SearchMate internal v14-01: v7 plus an exact KQ-versus-K root selector.

Numeric board, search, evaluation and general clock policy retain original v7.
The queen-only root selector uses permitted shipped Syzygy tablebase data through
preinstalled python-chess. No external engine code or network is shipped.
"""
...
def get_move(fen: str, time_left_ms: int) -> str:
    ...
    specialized = _kqk_select(reference, legal, deadline)
